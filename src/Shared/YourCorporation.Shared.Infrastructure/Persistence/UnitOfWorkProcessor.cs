...
{
    public class UnitOfWorkProcessor<T> : IUnitOfWorkProcessor where T : DbContext
    {
        private readonly T _dbContext;
        private readonly IDomainEventsBroker _domainEventsBroker;

        public UnitOfWorkProcessor(T dbContext, IDomainEventsBroker domainEventsBroker)
        {
